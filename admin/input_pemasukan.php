<?php
// qurban_app/admin/input_pemasukan.php
// Halaman untuk Administrator mencatat Pemasukan baru
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
   ...
   // Tipe transaksi untuk pemasukan
    $tipe_transaksi = 'Pemasukan';
    // Atau jika Anda sudah ubah kolom tipe_transaksi menjadi enum('Pemasukan','Pengeluaran'), gunakan 'Pemasukan'
    // $tipe_transaksi = 'Pemasukan'; 
    ...
    if (empty($kategori) || empty($deskripsi) || empty($jumlah) || empty($tgl_transaksi)) {
        ...
        try {
            ...
            if ($stmt->execute()) {
                ...
                header('Location: keuangan.php?status=pemasukan_success');
                exit();
            } else {
                $error_message = 'Gagal mencatat pemasukan.';
            }

        } catch (PDOException $e) {
            $error_message = 'Terjadi kesalahan database: ' . $e->getMessage();
            error_log("Add pemasukan error: " . $e->getMessage());
        }
    }
}
?>
...
<head>
    ...
    <title>Qurban App | Input Pemasukan</title>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                ...
                                <form method="POST" action="input_pemasukan.php" class="form-horizontal">
                                    <div class="form-group"><label class="col-sm-2 control-label">Kategori Pemasukan</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="kategori" class="form-control" required 
                                                   value="<?php echo htmlspecialchars($kategori); ?>">
                                            <span class="help-block m-b-none">Contoh: Iuran Pengqurban, Donasi, Penjualan Kulit.</span>
                                        </div>
                                    </div>
                                    <div class="form-group"><label class="col-sm-2 control-label">Deskripsi</label>
                                        <div class="col-sm-10">
                                            ...
                                            <span class="help-block m-b-none">Penjelasan singkat tentang pemasukan ini.</span>
                                        </div>
                                    </div>
                                    <div class="form-group"><label class="col-sm-2 control-label">Jumlah (Rp)</label>
                                        <div class="col-sm-10">
                                            ...
                                            <span class="help-block m-b-none">Masukkan angka saja, contoh: 500000.</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4 col-sm-offset-2">
                                            ...
                                            <button class="btn btn-primary" type="submit">Catat Pemasukan</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
